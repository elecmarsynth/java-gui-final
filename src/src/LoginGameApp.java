...
public class LoginGameApp {
    ...
    public static void main(String[] args) {
        ...
        BackgroundPanel bgPanel = new BackgroundPanel("plants-vs-zombies-game-of-the-year-edition-1w6gy.jpg");
    ...
    private static void initSound() {
        try {
            File file = new File("Rock Gaming Sport Energetic by Infraction [No Copyright Music]  Wrong Side.wav");
    ...
    private static void initClickSound() {
        try {
            File file = new File("Click_Captainsounds.wav");
            AudioInputStream audioStream = AudioSystem.getAudioInputStream(file);
